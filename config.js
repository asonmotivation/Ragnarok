...
module.exports = {
    ...
    SESSION: process.env.SESSION || 'Raganork~d32e1ddfdfa8db6afddd978d33d52c46:4e416a315a5536425538383d',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "ASON",
    BOT_NAME: process.env.BOT_NAME || 'LIGHTY',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'êª¶Í¢Ù­ASON;LIGHTY;https://imgur.com/a/FWaL2KV' : process.env.AUDIO_DATA,
